...
double cartan_export_exp(double* args);
...
double cartan_export_cartan_c_is_tree(double* args);
...
double cartan_export_cartan_tensor_sum(double* args);
double cartan_export_cartan_tensor_mean(double* args);
double cartan_export_cartan_tensor_max(double* args);
double cartan_export_cartan_tensor_min(double* args);
double cartan_export_cartan_tensor_sigmoid(double* args);
