...
if 'Stmt::MeshBlock {' not in code:
    mesh_codegen = '''            Stmt::MeshBlock { name, strategy, body } => {
            ...
            Stmt::FluidPrecisionBlock {'''
    code = code.replace('            Stmt::FluidPrecisionBlock {', mesh_codegen)
