...
4. **Integration Test Suite**:
   Created `tests/manifolds.car` to successfully compile typestates involving `in Minkowski` and `in PoincareDisk` and map them end-to-end to the new LLVM IR functions.
