...
1. **AST & Parser Integration**
   ...
   - You can now write `var tokens = tokenize_bpe("your text", "path/to/tokenizer.json");` natively in `.car` scripts.
...
4. **Testing Infrastructure**
   ...
   - Created `tests/bpe.car` to execute the code.

## Verification

> [!TIP]
> I successfully compiled the compiler and ran `cartanc build-exe tests/bpe.car`.
