...
We wrote a test suite in [shapes.car](file:///C:/Users/rich-/source/repos/CARTAN/tests/shapes.car) containing valid and invalid matrix multiplications. The compiler successfully verified the valid 2D @ 2D and 1D @ 2D multiplications, and threw a fatal `Diagnostic` error on the invalid dimension mismatch exactly as requested.
