...
## Verification Plan
### Automated Tests
- Create 	ests/geometry.car to define a custom manifold, allocate a tensor within it, and perform a forward and backward pass to verify the custom metric affects the gradients.
