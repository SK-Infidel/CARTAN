...
- Authored a smoke test (`test_phase5.car`) verifying that `absorb_layer_weights` and `align_spans` correctly compile to LLVM IR (`build-llvm`) without syntax or type-checker errors.
