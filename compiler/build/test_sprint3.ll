...
define void @test_simplification(ptr %arg_x) {
entry:
  %1 = alloca ptr, align 4
  store ptr %arg_x, ptr %1, align 4
  ; --- Begin Fused Kernel ---
  ; --- End Fused Kernel ---
...
entry:
  ...
  call void @cartan_absorb_weights(ptr @.str.0, ptr %8)
  %9 = load ptr, ptr %7, align 8
  %10 = call float @test_simplification_euclidean(ptr %9)
  ret i32 0
}
...
@.str.0 = private unnamed_addr constant [18 x i8] c"\64\75\6d\6d\79\5f\77\65\69\67\68\74\73\2e\62\69\6e\00", align 1
