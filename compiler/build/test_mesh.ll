...
entry:
  ...
  ; --- Begin Mesh Block: CoreCluster (Supervisor: AutoRestart) ---
  %1 = call ptr @cartan_tensor_alloc_nd(i32 2, i32 1024, i32 1024, i32 1, i32 1)
  %2 = alloca ptr, align 8
  store ptr %1, ptr %2, align 8
  %3 = alloca float, align 4
  store float 5.000000, ptr %3, align 4
  %4 = alloca float, align 4
  store float 10.000000, ptr %4, align 4
  ; --- Begin Fused Kernel ---
