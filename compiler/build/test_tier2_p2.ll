...
define void @test_tier2_p2() {
entry:
  %1 = call ptr @cartan_internal_import_onnx(ptr @.str.model.uri.0)
  %2 = alloca ptr, align 8
  store ptr %1, ptr %2, align 8
  %3 = alloca ptr, align 8
  store ptr @.str.prompt.1, ptr %3, align 8
  %4 = alloca ptr, align 8
  %5 = call ptr @cartan_tensor_alloc_nd(i32 3, i32 224, i32 224, i32 3, i32 1)
  %6 = alloca ptr, align 8
  store ptr %5, ptr %6, align 8
  %7 = load ptr, ptr %2, align 8
  %8 = load ptr, ptr %6, align 8
  call void @cartan_project_vocab(ptr %7, ptr %8)
  %9 = load ptr, ptr %6, align 8
  call void @cartan_weight_decay(ptr %9, float 0.01)
  ; JIT BLOCK BEGIN
...
@.str.model.uri.0 = private unnamed_addr constant [16 x i8] c"hf://meta-llama\00", align 1
@.str.prompt.1 = private unnamed_addr constant [13 x i8] c"hello {user}\00", align 1
