...
define void @test_fusion() {
entry:
  %1 = call ptr @cartan_tensor_alloc_nd(i32 2, i32 64, i32 128, i32 1, i32 1)
  %2 = alloca ptr, align 8
  store ptr %1, ptr %2, align 8
  %3 = call ptr @cartan_tensor_alloc_nd(i32 2, i32 128, i32 32, i32 1, i32 1)
  %4 = alloca ptr, align 8
  store ptr %3, ptr %4, align 8
  %5 = call ptr @cartan_tensor_alloc_nd(i32 2, i32 64, i32 32, i32 1, i32 1)
  ...
  %10 = call ptr @cartan_tensor_linear_relu(ptr %7, ptr %8, ptr %9)
  ; --- End Fused Kernel (Pattern Matched) ---
