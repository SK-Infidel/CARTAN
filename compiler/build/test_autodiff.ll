...
define ptr @forward(ptr %arg_weights, ptr %arg_activations) {
entry:
  %1 = alloca ptr, align 4
  store ptr %arg_weights, ptr %1, align 4
  %2 = alloca ptr, align 4
  store ptr %arg_activations, ptr %2, align 4
  %3 = load ptr, ptr %2, align 8
  %4 = load ptr, ptr %1, align 8
  %5 = call ptr @cartan_tensor_matmul(ptr %3, ptr %4)
  %6 = alloca ptr, align 8
  store ptr %5, ptr %6, align 8
  ; --- ones_like ---
  %7 = load ptr, ptr %6, align 8
  %8 = call ptr @cartan_tensor_ones_like(ptr %7)
  %9 = alloca ptr, align 8
  store ptr %8, ptr %9, align 8
  %10 = load ptr, ptr %9, align 8
  ; --- Transpose ---
  %11 = load ptr, ptr %1, align 8
  %12 = call ptr @cartan_tensor_transpose(ptr %11)
  %13 = call ptr @cartan_tensor_matmul(ptr %10, ptr %12)
  %14 = alloca ptr, align 8
  store ptr %13, ptr %14, align 8
  ; --- Transpose ---
  %15 = load ptr, ptr %2, align 8
  %16 = call ptr @cartan_tensor_transpose(ptr %15)
  %17 = load ptr, ptr %9, align 8
  %18 = call ptr @cartan_tensor_matmul(ptr %16, ptr %17)
  %19 = alloca ptr, align 8
  store ptr %18, ptr %19, align 8
  ; --- Begin Backward Pass ---
  %20 = load ptr, ptr %6, align 8
  call void @cartan_tensor_backward(ptr %20)
